...
set multiplot
plot "< awk '$3 == 1' mcMmWaveSwitchStats_5_10_31_07_2018_04_52_12.txt" using ($2):($4) w steps ls 1 lw 2 lc rgb "blue" title ' ID' axes x1y2

set key top left
plot "< awk '$2 == 1' LteSinrTime.txt" using 1:($4) smooth mcsplines ls 1 lw 2 lc rgb "#006400" title ' SINR (eNB 1)' axes x1y1, \
"< awk '$3 == 2' mcMmWaveSinrTime_5_10_31_07_2018_04_52_12.txt" using 1:($4) smooth mcsplines ls 1 lw 1 lc rgb "red" notitle axes x1y1, \
"< awk '$3 == 3' mcMmWaveSinrTime_5_10_31_07_2018_04_52_12.txt" using 1:($4) smooth mcsplines ls 1 lw 1 lc rgb "#ff8000" notitle axes x1y1, \
NaN with lines ls 1 lw 2 lc rgb "red" title "SINR (eNB 2)", \
NaN with lines ls 1 lw 2 lc rgb "#ff8000" title "SINR (eNB 3)"
unset multiplot
